...
DECLARE @ApplicationCode VARCHAR(20) = '$safeproductname_lower$'
...
BEGIN
	INSERT INTO [dbo].[Clients] (
		...
		'$safeproductname$',--[ClientName],
		'$safeproductname$ Client',--[Description],
		'https://localhost:4200',--[ClientUri],
		'https://localhost:4200/favicon.ico',--[LogoUri],
		0,--[RequireConsent],
