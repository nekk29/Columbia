...
namespace Columbia.Dsl
{
	...
	/// </summary>
	internal partial class ColumbiaExplorer : ColumbiaExplorerBase
	{
		/// <summary>
		/// Constructs a new ColumbiaExplorer.
		/// </summary>
		public ColumbiaExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the ColumbiaExplorerToolWindow.
	/// </summary>
	internal abstract class ColumbiaExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new ColumbiaExplorerBase.
		/// </summary>
		protected ColumbiaExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.ColumbiaExplorerMenu;
			}
		}
