...
namespace Columbia.Dsl
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.ColumbiaEditorFactoryId)]
	internal partial class ColumbiaEditorFactory : ColumbiaEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new ColumbiaEditorFactory.
		/// </summary>
		public ColumbiaEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ColumbiaEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected ColumbiaEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new ColumbiaDocData(this.ServiceProvider, typeof(ColumbiaEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new ColumbiaDocView(docData, this.ServiceProvider);
		}
	}
}
