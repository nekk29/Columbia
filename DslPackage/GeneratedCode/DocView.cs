...
namespace Columbia.Dsl
{
	...
	/// </summary>
	internal partial class ColumbiaDocView : ColumbiaDocViewBase
	{
		/// <summary>
		/// Constructs a new ColumbiaDocView.
		/// </summary>
		public ColumbiaDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ColumbiaDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ColumbiaDocView.
		/// </summary>
		protected ColumbiaDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			ColumbiaDocDataBase docData = this.DocData as ColumbiaDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ColumbiaDocViewBase should be an ColumbiaDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Columbia.Dsl.ColumbiaDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Columbia.Dsl.ColumbiaDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Columbia.Dsl.ColumbiaToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Columbia.Dsl.ColumbiaToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ColumbiaDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Columbia.Dsl.ColumbiaHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Columbia.Dsl.ColumbiaHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Columbia.Dsl.ColumbiaHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
