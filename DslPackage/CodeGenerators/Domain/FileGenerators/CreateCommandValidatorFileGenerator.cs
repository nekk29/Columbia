...
{
    internal class CreateCommandValidatorFileGenerator : FileGeneratorBase<CreateCommandValidatorCodeGenerator>
    {
        ...
        {
            return entity != null ? $"Commands\\{entity.Name}\\Create{entity.Name}CommandValidator.cs" : null;
        }
    }
}
