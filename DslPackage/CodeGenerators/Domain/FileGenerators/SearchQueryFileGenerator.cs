...
{
    internal class SearchQueryFileGenerator : FileGeneratorBase<SearchQueryCodeGenerator>
    {
        ...
        {
            return entity != null ? $"Queries\\{entity.Name}\\Search{entity.Name}Query.cs" : null;
        }
    }
}
