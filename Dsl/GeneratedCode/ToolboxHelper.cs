...
namespace Columbia.Dsl
{
	...
	/// </remarks>
	public partial class ColumbiaToolboxHelper : ColumbiaToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new ColumbiaToolboxHelper.
		/// </summary>
		public ColumbiaToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class ColumbiaToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify Columbia toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "Columbia.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new ColumbiaToolboxHelperBase.
		/// </summary>
		protected ColumbiaToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Columbia.Dsl.ColumbiaDomainModel.SingletonResourceManager.GetString("ColumbiaToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Columbia.Dsl.ColumbiaDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Columbia.Dsl.EntityToolboxItem":
					// Add Entity shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Columbia.Dsl.EntityToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Columbia.Dsl.ColumbiaToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("ColumbiaToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"CreateEntityF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("EntityToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						CreateElementToolPrototype(store, global::Columbia.Dsl.Entity.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Columbia.Dsl.EntityRelationshipToolboxItem":

					// Add EntityRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Columbia.Dsl.EntityRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Columbia.Dsl.ColumbiaDomainModel));
