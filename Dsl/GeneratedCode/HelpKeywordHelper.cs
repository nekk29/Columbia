...
namespace Columbia.Dsl
{
	...
	/// </remarks>
	public partial class ColumbiaHelpKeywordHelper : ColumbiaHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ColumbiaHelpKeywordHelper.
		/// </summary>
		protected ColumbiaHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ColumbiaHelpKeywordHelper.
		/// </summary>
		public static ColumbiaHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ColumbiaHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ColumbiaHelpKeywordHelperBase.
		/// </summary>
		protected ColumbiaHelpKeywordHelperBase()
			: base() { }
